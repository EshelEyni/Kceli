...
const setupALSMiddleware_1 = __importDefault(
  require("../../middlewares/setupALS/setupALSMiddleware")
);
...
const workoutRouter_1 = __importDefault(require("../../routers/workout/workoutRouter"));
const nutritionRouter_1 = __importDefault(require("../../routers/nutrition/nutritionRouter"));
const intakeRouter_1 = __importDefault(require("../../routers/intake/intakeRouter"));
const goalRouter_1 = __importDefault(require("../../routers/goal/goalRouter"));
...
app.use("/api/workout", workoutRouter_1.default);
app.use("/api/nutrition", nutritionRouter_1.default);
app.use("/api/intake", intakeRouter_1.default);
app.use("/api/goal", goalRouter_1.default);
app.get("/**", (req, res) => {
