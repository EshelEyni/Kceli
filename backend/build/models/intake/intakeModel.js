...
intakeItemSchema.pre("validate", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (intakeItem.calories || intakeItem.name.toLowerCase() === "water")
                return next();
            ...
            if (existingItemData && existingItemData.calories) {
                this.calories = Math.round(existingItemData.calories * (intakeItem.quantity / existingItemData.quantity));
            }
            else {
                this.calories = Math.round(yield openAIService_1.default.getCaloriesForIntakeItem(intakeItem));
            }
        }
        catch (error) {
...
const favoriteIntakeSchema = new mongoose_1.Schema(Object.assign(Object.assign({}, intakeSchema.obj), { userId: {
...
const FavoriteIntakeModel = mongoose_1.default.model("FavoriteIntake", favoriteIntakeSchema, "favorite_intakes");
