...
const workout_1 = require("../../../../shared/dist/types/workout");
...
function validateAnaerobicFields(value) {
  ...
  if (!this.sets) throw new errorService_1.AppError("Sets are required for anaerobic type", 400);
  if (!this.reps) throw new errorService_1.AppError("Reps are required for anaerobic type", 400);
  if (!this.weight) throw new errorService_1.AppError("Weight is required for anaerobic type", 400);
  if (!this.weightUnit)
...
function validateSupersetFields(value) {
  ...
  if (!this.sets) throw new errorService_1.AppError("Sets are required for superset type", 400);
  if (!this.restInSec)
    throw new errorService_1.AppError("RestInSec is required for superset type", 400);
  if (!this.items) throw new errorService_1.AppError("Items are required for superset type", 400);
  return true;
}
