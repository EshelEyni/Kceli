...
exports.updatePassword = exports.resetPassword = exports.sendPasswordResetEmail = exports.logout = exports.signup = exports.loginWithToken = exports.login = void 0;
...
const sendPasswordResetEmail = (0, errorService_1.asyncErrorCatcher)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.body;
    if (!email)
        throw new errorService_1.AppError("Email is required", 400);
    if (!_isValidEmail(email))
        throw new errorService_1.AppError("Email is invalid", 400);
    const resetURL = `${req.protocol}://${req.get("host")}/api/auth/resetPassword/`;
    yield authService_1.default.sendPasswordResetEmail(email, resetURL);
    res.send({
        status: "success",
